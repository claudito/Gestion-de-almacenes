...
elegido=$(this).val();
$.post("../ajax/consulta-stock.php", { elegido: elegido }, function(data){

$("#id_stock").html(data);
});     
});

$("#id_stock").html("<center><img src='../assets/img/cargando.gif'/></center>");
}); 
...
<div class="row">
 ...
 <div class="panel panel-default">
 	<div class="panel-heading">
 		<h3 class="panel-title">Consulta de Stock</h3>
 	</div>
...
<div class="row">
 ...
 <div class="panel panel-default">
     ...
     <div id="id_stock">
     <?php include('../templates/grid/consulta-stock.php'); ?>
     </div>
