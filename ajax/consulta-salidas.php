...
DATE_FORMAT(m.fecha_creacion,'%d/%m/%Y')as fecha_creacion,m.tipo FROM movalmcab as m INNER JOIN usuarios as u  ON m.usuarios_idusuarios=u.idusuarios WHERE 
LEFT(m.documento,3)='".$serie_doc."' AND centro_costo='".$centro_costo."' AND m.tipo='NS'";
...
<div class="table-responsive">
	<table  id="consulta" class="table table-bordered table-condensed">
        ...
        <?php include('../templates/modal/nota-salida/eliminar.php'); ?>
        </td>
